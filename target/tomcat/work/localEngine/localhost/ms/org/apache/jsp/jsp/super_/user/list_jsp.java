...
String basePath = request.getScheme() + "://"+ request.getServerName() + ":" + request.getServerPort()+ path + "/";
      ...
      out.print(basePath);
      out.write("super/user/list\" method=\"post\">\r\n");
      ...
      out.write("\t\t\t\t\t管理员名称：\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t<td><input id=\"name\" name=\"name\" type='text'></td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t</table>\r\n");
      ...
      out.print(basePath );
      out.write("super/user/addshow\" ><span>添加管理员</span></a></li>\r\n");
      out.write("\t\t\t<li><a class=\"edit\"   target=\"dialog\"  height=\"420\" href=\"");
      out.print(basePath );
      out.write("super/user/getById?id={sid}\" ><span>修改管理员</span></a></li>\r\n");
      out.write("\t\t\t<li><a class=\"edit\"   target=\"dialog\"  height=\"420\" href=\"");
      out.print(basePath );
      out.write("super/user/changerole/show?id={sid}\" ><span>修改管理员角色</span></a></li>\r\n");
      out.write("\t\t\t<li><a class=\"delete\"   href=\"");
      out.print(basePath );
      out.write("super/user/delete\"   target=\"selectedTodo\" rel=\"ids\" postType=\"string\" title=\"确定要删除该管理员吗？这将同时也删除此用户所对应的权限和角色信息!\"><span>删除管理员</span></a></li>\r\n");
      out.write("\t\t\t<li><a class=\"edit\"   href=\"");
      out.print(basePath );
      out.write("common/user/formatpass\"   target=\"selectedTodo\" rel=\"ids\" postType=\"string\" title=\"确定要初始化密码吗？\"><span>初始化密码</span></a></li>\r\n");
      out.write("\t\t</ul>\r\n");
      out.write("\t</div>\r\n");
      ...
      out.write("\t\t\t\t<th width=\"120\" >管理员名称</th>\r\n");
      out.write("\t\t\t\t<th width=\"120\" >管理员id</th>\r\n");
      out.write("\t\t\t\t<th width=\"120\" >角色id</th>\r\n");
      out.write("\t\t\t\t<th width=\"120\" >角色名称</th>\r\n");
      out.write("\t\t\t\t<th width=\"120\" >拥有权限</th>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t</thead>\r\n");
      out.write("\t\t<tbody>\r\n");
      out.write("\t\t\t");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(PageContext _jspx_page_context)
    ...
    // /jsp/super/user/list.jsp(55,3) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setVar("item");
    // /jsp/super/user/list.jsp(55,3) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/jsp/super/user/list.jsp(55,3) '${pageInfo.list}'",_el_expressionfactory.createValueExpression(_jspx_page_context.getELContext(),"${pageInfo.list}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
    // /jsp/super/user/list.jsp(55,3) name = varStatus type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    try {
      ...
      if (_jspx_eval_c_005fforEach_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("</td>\r\n");
          out.write("\t\t\t\t\t<td>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${item.permissions}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
          out.write("</td>\r\n");
          out.write("\t\t\t\t</tr>\r\n");
          out.write("\t\t\t");
