...
String basePath = request.getScheme() + "://"+ request.getServerName() + ":" + request.getServerPort()+ path + "/";
      ...
      out.print(basePath);
      out.write("super/role/list\" method=\"post\">\r\n");
      ...
      out.write("\t\t\t\t\t角色名称：\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t<td><input id=\"roleName\" name=\"roleName\" type='text'></td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t</table>\r\n");
      ...
      out.print(basePath );
      out.write("super/role/addshow\" ><span>添加角色</span></a></li>\r\n");
      out.write("\t\t\t<li><a class=\"edit\"   target=\"dialog\"  height=\"420\" href=\"");
      out.print(basePath );
      out.write("super/role/getById?roleid={sid}\" ><span>编辑角色</span></a></li>\r\n");
      out.write("\t\t\t<li><a class=\"edit\"   target=\"dialog\"  height=\"420\" href=\"");
      out.print(basePath );
      out.write("super/permission/chmpermission/show?roleid={sid}\" ><span>编辑权限</span></a></li>\r\n");
      out.write("\t\t\t<li><a class=\"delete\"   href=\"");
      out.print(basePath );
      out.write("super/role/delete\"   target=\"selectedTodo\" rel=\"ids\" postType=\"string\" title=\"确定要删除该角色吗？这将导致所有拥有此角色的用户永久失去该角色对应的权限!\"><span>删除角色</span></a></li>\r\n");
      out.write("\t\t</ul>\r\n");
      out.write("\t</div>\r\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(PageContext _jspx_page_context)
    ...
    // /jsp/super/role/list.jsp(51,3) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setVar("item");
    // /jsp/super/role/list.jsp(51,3) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/jsp/super/role/list.jsp(51,3) '${pageInfo.list}'",_el_expressionfactory.createValueExpression(_jspx_page_context.getELContext(),"${pageInfo.list}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
    // /jsp/super/role/list.jsp(51,3) name = varStatus type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
